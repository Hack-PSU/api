...
export class ScannerController extends AbstractScannerController implements IExpressController {
   ...
   * @apiSuccess {PinToken} data Pin Token containing temporary authentication pin, validity, and other metadata
   ...
   *
   * @apiGroup Admin Scanner
   * @apiParam {String} pin A pin generated by calling the GET: /register route
   * @apiParam {String} macaddr The mac address of the scanner to regiser
   * @apiSuccess {ApiToken} data API Token containing api key, validity, and other metadata
   * @apiUse ResponseBodyDescription
   * @apiUse IllegalArgumentError
   * @apiUse ResponseBodyDescription
   */
