...
let CategoryDataMapperImpl = class CategoryDataMapperImpl extends generic_data_mapper_1.GenericDataMapper {
    constructor(acl, sql, logger) {
        super(acl);
        this.sql = sql;
        this.logger = logger;
        this.COUNT = 'category:count';
        this.CREATE = 'category:create';
        this.DELETE = 'category:delete';
        this.READ = 'category:read';
        this.READ_ALL = 'category:readall';
        this.UPDATE = 'category:update';
        this.tableName = 'CATEGORY_LIST';
        this.pkColumnName = 'uid';
        super.addRBAC([this.READ, this.READ_ALL], [
            auth_types_1.AuthLevel.TEAM_MEMBER,
        ]);
    }
    delete(id) {
    ...
    get(id, opts) {
        ...
        return rxjs_1.from(this.sql.query(query.text, query.values, { cache: true }))
            .pipe(operators_1.map((category) => ({ result: 'Success', data: category[0] })))
            .toPromise();
    }
    /**
     *
    ...
    getAll(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return rxjs_1.from(this.sql.query(query, [], { cache: true }))
                .pipe(operators_1.map((categories) => ({ result: 'Success', data: categories })))
                .toPromise();
        });
    }
    /**
...
CategoryDataMapperImpl = __decorate([
    ...
    __metadata("design:paramtypes", [Object, mysql_uow_service_1.MysqlUow,
        logging_1.Logger])
], CategoryDataMapperImpl);
exports.CategoryDataMapperImpl = CategoryDataMapperImpl;
//# sourceMappingURL=category-data-mapper-impl.js.map