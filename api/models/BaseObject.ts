...
import { IUow, IUowOpts } from '../services/database/uow';
...
export default abstract class BaseObject {
   ...
   * @private
   */
  protected get dbRepresentation() {
   ...
   */
  protected abstract get id();

  /**
   * A flag indicating whether the object uses the real-time database querying
   * @returns {boolean}
   */
  protected get useRTDB() {
    return false;
  }
  ...
  /**
   * @return {string} Name of Table for SQL based objects
   */
