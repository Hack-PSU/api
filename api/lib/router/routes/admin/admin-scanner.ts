...
export class AdminScannerController extends ScannerController implements IExpressController {
   ...
   * @apiSuccess {RepsonseBody} pinToken Pin Token containing temporary authentication pin, validity, and other metadata
   ...
   * @apiSuccess {RepsonseBody} apiToken API Token containing api key, validity, and other metadata
   * @apiUse ResponseBodyDescription
   * @apiUse AuthArgumentRequired
   * @apiUse IllegalArgumentError
   */
