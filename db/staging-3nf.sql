...
-- -----------------------------------------------------
  ...
  CREATE TABLE IF NOT EXISTS `staging`.`BUDGET_ITEMS` (
    ...
    CONSTRAINT `fk_budget_item_hackathon_id` FOREIGN KEY (`hackathon`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT
  ) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
  -- Table `staging`.`CATEGORY_LIST`
  -- -----------------------------------------------------
  ...
  INDEX `fk_category_id_hackathon_id_idx` (`hackathon_id` ASC) CONSTRAINT `fk_category_id_hackathon_id_idx` FOREIGN KEY(`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`CHECKOUT_ITEMS` (
  ...
  INDEX `fk_chitem_id_hackathon_id_idx` (`hackathon_id` ASC) CONSTRAINT `fk_chitem_id_hackathon_id_idx` FOREIGN KEY(`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`REGISTRATIONS` (
  ...
  CONSTRAINT `fk_user_id_hackathon_id_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`CHECKOUT_DATA` (
  ...
  CONSTRAINT `fk_chdata_hackathon_id_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_chdata_user_id_idx` FOREIGN KEY (`user_id`) REFERENCES `staging`.`REGISTRATIONS` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_chdata_chitem_id_idx` FOREIGN KEY (`chitem_id`) REFERENCES `staging`.`CHECKOUT_ITEMS` (`chitem_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`EVENTS` (
  ...
  `event_type` ENUM('food', 'workshop', 'activity') NOT NULL,
  `hackathon_id` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`event_id`),
  INDEX `fk_events_location_id_idx` (`location_id` ASC),
  INDEX `fk_events_hackathon_id_idx` (`hackathon_id` ASC),
  CONSTRAINT `fk_events_hackathon_id_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_events_location_id_idx` FOREIGN KEY (`location_id`) REFERENCES `staging`.`LOCATIONS` (`location_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`EXTRA_CREDIT_CLASSES` (
  ...
  CONSTRAINT `fk_ec_classes_hackathon_id_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`EXTRA_CREDIT_ASSIGNMENT` (
  ...
  CONSTRAINT `fk_ec_assign_class_id_idx` FOREIGN KEY (`ec_class_id`) REFERENCES `staging`.`EXTRA_CREDIT_CLASSES` (`ec_class_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_ec_assign_user_id_idx` FOREIGN KEY (`user_id`) REFERENCES `staging`.`REGISTRATIONS` (`user_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`PROJECT_LIST` (
  ...
  CONSTRAINT `fk_proj_list_hackathon_id_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`PROJECT_CATEGORIES` (
  ...
  CONSTRAINT `fk_proj_cat_id_fk` FOREIGN KEY (`category_id`) REFERENCES `staging`.`CATEGORY_LIST` (`category_id`),
  CONSTRAINT `fk_proj_cat_proj_list_id_fk` FOREIGN KEY (`proj_id`) REFERENCES `staging`.`PROJECT_LIST` (`proj_id`)
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`PROJECT_TEAMS` (
  ...
  CONSTRAINT `fk_proj_team_proj_fk` FOREIGN KEY (`proj_id`) REFERENCES `staging`.`PROJECT_LIST` (`proj_id`),
  CONSTRAINT `fk_proj_team_hackathon_id_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_proj_team_user_id_idx` FOREIGN KEY (`user_id`) REFERENCES `staging`.`REGISTRATIONS` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`REIMBURSEMENTS` (
  ...
  CONSTRAINT `fk_reimbursement_item_id` FOREIGN KEY (`item_id`) REFERENCES `staging`.`BUDGET_ITEMS` (`budget_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_reimbursement_hackathon_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_reimbursement_receipt_id` FOREIGN KEY (`receipt_id`) REFERENCES `staging`.`RECEIPTS` (`receipt_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`RFID_ASSIGNMENTS` (
  ...
  CONSTRAINT `fk_rfid_assign_hackathon_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_rfid_assign_user_id_idx` FOREIGN KEY (`user_id`) REFERENCES `staging`.`REGISTRATIONS` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table `staging`.`RSVPS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staging`.`RSVPS` (
  ...
  CONSTRAINT `fk_rsvp_hackathon_id_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_rsvp_user_id_idx` FOREIGN KEY (`user_id`) REFERENCES `staging`.`REGISTRATIONS` (`user_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table `staging`.`SCANS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staging`.`SCANS` (
  ...
  CONSTRAINT `fk_scan_id_location_id_idx` FOREIGN KEY (`location_id`) REFERENCES `staging`.`LOCATIONS` (`location_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_scan_id_rfid_id_idx` FOREIGN KEY (`rfid_id`) REFERENCES `staging`.`RFID_ASSIGNMENTS` (`rfid_id`) ON DELETE RESTRICT ON UPDATE NO ACTION,
  CONSTRAINT `fk_scan_id_event_id_idx` FOREIGN KEY (`event_id`) REFERENCES `staging`.`EVENTS` (`event_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_scan_id_hackathon_id_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`TABLE_SUPPORT` (
  ...
  CONSTRAINT `fk_tbl_support_category_id_idx` FOREIGN KEY (`category_id`) REFERENCES `staging`.`CATEGORY_LIST` (`category_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_tbl_support_hackathon_id_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `staging`.`TABLE_ASSIGNMENTS` (
  ...
  CONSTRAINT `fk_tbl_assign_tbl_id_idx` FOREIGN KEY (`tbl_id`) REFERENCES `staging`.`TABLE_SUPPORT` (`tbl_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_tbl_assign_hackathon_id_idx` FOREIGN KEY (`hackathon_id`) REFERENCES `staging`.`HACKATHONS` (`hackathon_id`) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `fk_tbl_assign_proj_id_idx` FOREIGN KEY (`proj_id`) REFERENCES `staging`.`PROJECT_LIST` (`proj_id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
-- -----------------------------------------------------
DELIMITER $$ USE `staging` $$ CREATE DEFINER = `hackpsudev` @`%` PROCEDURE `assign_table`(
...
SET
  `tbl_num_param`: = (
    ...
    WHERE
      ...
      AND `hackathon_id` = `@hackathon_var`
      AND `tbl_id` NOT IN (
        SELECT
          `tbl_num`
        FROM
          `TABLE_ASSIGNMENTS` `tbl_assignment`
        WHERE
          `hackathon` = `@hackathon_var` FOR
        UPDATE
      )
    ORDER BY
      `tbl_assignment`.`priority` DESC
    LIMIT
...
-- -----------------------------------------------------
DELIMITER $$ USE `staging` $$ CREATE DEFINER = `hackpsudev` @`%` PROCEDURE `assign_team`(
  IN `proj_name_param` VARCHAR(50),
  IN `team_ids_param` LONGTEXT,
  IN `proj_cat_param` LONGTEXT,
  IN `proj_desc_param` LONGTEXT,
  out `proj_id_param` varchar(45)
) proc_lbl :begin
SET
  @hackathon_var: = (
    SELECT
...
SET
  @len: = LOCATE(',', `team_ids_param`) - @pos;
-- No commas found: only one id provided
  IF @len = -1 THEN
SET
  @len: = CHAR_LENGTH(team_ids_param);
END IF;
...
SET
  @team_member: = SUBSTRING(team_ids_param, @pos, @len);
...
SET
  @num: = (
    ...
    WHERE
      `user_id` = @team_member
      AND `hackathon_id` = @hackathon_var LOCK IN SHARE MODE
  );
-- throw error for duplicates
  IF @num > 0 THEN SIGNAL SQLSTATE '45000'
SET
  message_text = 'duplicate user detected';
leave proc_lbl;
END IF;
SET
  @pos: = @pos + @len + 1;
SET
  @n: = LOCATE(',', team_ids_param, @pos);
-- If no more commas, check duplicate (hack for last id)
  IF @n = 0 THEN
set
  @teamMember: = SUBSTRING(team_ids_param, @pos, @len);
SET
  @num: = (
    SELECT
      COUNT(*)
...
SET
  proj_id_param: = UUID();
INSERT INTO
  `PROJECT_LIST` (`proj_id`, `name`, `description`, `hackathon_id`)
values
  (
    `proj_id_param`,
    `proj_name_param`,
...
SET
  @pos: = 1;
SET
  @len: = LOCATE(',', proj_cat_param) - @pos;
IF @len = -1 THEN
SET
  @len: = CHAR_LENGTH(proj_cat_param);
END IF;
SET
  @num: = 0;
...
SET
  @cat: = SUBSTRING(proj_cat_param, @pos, @len);
INSERT INTO
  `PROJECT_CATEGORIES` (`proj_cat_id`, `proj_id`, `cat_id`)
VALUES
  (UUID(), proj_id_param, @cat);
SET
  @pos: = @pos + @len + 1;
SET
  @n: = LOCATE(',', proj_cat_param, @pos);
...
USE `staging`;
CREATE
OR REPLACE ALGORITHM = UNDEFINED DEFINER = `hackpsudev` @`%` SQL SECURITY DEFINER VIEW `staging`.`ATTENDANCE` AS
select
  ...
  `staging`.`HACKATHON`.`hackathon_id` AS `hackathon_id`,
  `staging`.`HACKATHON`.`name` AS `hackathon_name`,
  `staging`.`HACKATHON`.`start_time` AS `hackathon_start_time`,
  `staging`.`HACKATHON`.`end_time` AS `hackathon_end_time`,
  `staging`.`HACKATHON`.`base_pin` AS `hackathon_base_pin`,
  `staging`.`HACKATHON`.`active` AS `hackathon_active`
FROM
  (
    (
      (
        `staging`.`RFID_ASSIGNMENTS`
        JOIN `staging`.`SCANS` ON(
          (
            `staging`.`RFID_ASSIGNMENTS`.`rfid_id` = `staging`.`SCANS`.`rfid_id`
          )
        )
      )
      JOIN `staging`.`EVENTS` ON(
        (
          `staging`.`SCANS`.`event_id` = `staging`.`EVENTS`.`event_id`
        )
      )
    )
    JOIN `staging`.`HACKATHON` ON(
      (
        `staging`.`RFID_ASSIGNMENTS`.`hackathon_id` = `staging`.`HACKATHON`.`hackathon_id`
      )
    )
  )
ORDER BY
...
USE `staging`;
CREATE
  OR REPLACE ALGORITHM = UNDEFINED DEFINER = `hackpsudev` @`%` SQL SECURITY DEFINER VIEW `staging`.`ATTENDANCE_LEGACY` AS
SELECT
  `staging`.`SCANS`.`scan_id` AS `scan_id`,
  ...
  (
    (
      (
        ...
        JOIN `staging`.`LOCATIONS` ON(
          (
            `staging`.`SCANS`.`location_id` = `staging`.`LOCATIONS`.`location_id`
          )
        )
      )
      JOIN `staging`.`EVENTS` ON(
        (
          (
            `staging`.`LOCATIONS`.`location_id` = `staging`.`EVENTS`.`location_id`
          )
          AND (
            `staging`.`SCANS`.`time` BETWEEN (`staging`.`EVENTS`.`start_time`)
            AND `staging`.`EVENTS`.`end_time`
          )
          AND (
            `staging`.`EVENTS`.`type` IN ('workshop', 'food')
          )
        )
      )
    )
    JOIN `staging`.`HACKATHONS` ON(
      (
        `staging`.`RFID_ASSIGNMENTS`.`hackathon_id` = `staging`.`HACKATHONS`.`hackathon_id`
      )
    )
  )
ORDER BY
